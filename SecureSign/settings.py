...
SECRET_KEY = 'django-insecure--xr84@yqs&s@z!*mt=pt^eshb0z^%j4+#tzal*@wt^7mtisxot'
...
MIDDLEWARE = [
    ...
    'accounts.middleware.AppAuthenticationMiddleware',
...
EMAIL_HOST = 'smtp.office365.com' # for outlook email
EMAIL_PORT = 587
EMAIL_USE_TLS = True
